...
const submitQuizSchema = Joi.object({
  ...
  answers: Joi.object()
    .pattern(Joi.number().integer(), Joi.number().integer().min(0).max(3))
    .required()
    .messages({
      "object.base": "Answers must be an object with question IDs as keys",
...
const getMyResultsSchema = Joi.object({
